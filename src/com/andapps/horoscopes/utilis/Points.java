...
/*
 * add a notification that notifies him that he needs to take action to keep
 * getting notified everyday 
 * @ give points for sharing the app
 * @ give points for inviting other users.
 * @ give points for rating the app
 * @ the point count can be registered on shared or on the server
 * @if he doesnt want to keep doing this he can pay and we will also remove the ads
 */
